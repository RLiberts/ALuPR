...
bool num; //deklerē boolean tipa mainīgo, kas aptvers to vai vispār pastāv kāds skaitlis, kas dalās noteiktajā intervālā
do
...
cin >> k;
num = false; // Piešķir vērtību false, kamēr nav atrasts neviens skaitlis, kas dalās ar k intervālā [n;m]
cout << "Skaitļi, kuri atrodas intervālā " << m << "-" << n << " un dalās ar " << k << ":" << endl;
for (int i=m; i<=n; m++){ //deklerērts i un piešķirta sākotnējā vērtība m, jo m ir mūsu intervāla sākumpunkts.
